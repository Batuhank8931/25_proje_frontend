                  ...
                  <div className="flex items-center border-b border-b-gray-300 w-full">
                    <div className="flex justify-between items-center m-4 w-80">
                      <div className="flex items-center">
                        <h2 className="text-xl text-blue-800 mr-2 uppercase">
                          {board.name}
                        </h2>
                        <span className="text-sm text-blue-600 bg-blue-100 rounded-full w-6 h-6 flex items-center justify-center">
                          {board.tasks.length}
                        </span>
                      </div>
                        ...
                        <button className="text-gray-500 hover:text-gray-700">
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M10.0002 0.75C15.1082 0.75 19.2502 4.891 19.2502 10C19.2502 15.108 15.1082 19.25 10.0002 19.25C4.89124 19.25 0.750244 15.108 0.750244 10C0.750244 4.892 4.89224 0.75 10.0002 0.75Z"
                              stroke="#98A2B3"
                              strokeWidth="1.5"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                  ...
                  <div className="space-y-1 m-1">
                            ...
                            <div className="flex justify-between items-start text-orange-500  hover:bg-blue-500 hover:text-blue-100 hover:rounded-lg ">
                              ...
                              <div className="flex -space-x-2 overflow-hidden">
                                ...
                                <img
                                  ...
                                  className="w-8 h-8 rounded-full border-2 border-white"
                                />
                                <span className="w-8 h-8 rounded-full border-2 border-white text-gray-500 text-sm bg-gray-200 flex items-center justify-center">
                                  +5
                                </span>
                              </div>
                            </div>
                    ...
                    {board.tasks.length !== 0 && (
                      <div className="flex items-center justify-center">
                        {" "}
                        <button
                          className="bg-white text-gray-500 px-4 py-2 rounded-lg hover:bg-gray-200"
                          onClick={() => handleNewTaskOpen(board.id)}
                        >
                          + New Task
                        </button>
                    ...
                    {board.tasks.length === 0 && (
                      <div className="relative flex items-center justify-center h-96">
                        <div className="group relative flex items-center justify-center h-96 w-full flex-col">
                          <img
                            src="/notask.PNG"
                            alt="notask"
                            className="w-60"
                          />
                          <button
                            className="hidden group-hover:block bg-white text-gray-500 px-4 py-2 rounded-lg hover:bg-gray-200"
                            onClick={() => handleNewTaskOpen(board.id)}
                          >
                            + New Task
                          </button>
