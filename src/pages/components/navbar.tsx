...
const Navbar = () => {
    return (
        <div className="flex items-center justify-between px-4 py-4 bg-white border-b border-blue-200">
            <div className="text-blue-800 text-lg font-bold">kargakarga</div>
            <div className="flex items-center space-x-4">
                ...
                <button className="text-gray-500 hover:text-gray-700 pr-3">
                    <img src="/25.PNG" alt="25" className="w-12 h-12" />
                </button>
            </div>
        </div>
    );
